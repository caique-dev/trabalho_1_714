...
a carga agregada é $\lambda/\mu$. Como $U_i$ é a fração de tempo ocupado, a
soma das utilizações é o número médio de servidores ocupados e mede esse
mesmo trabalho:
\begin{equation}
